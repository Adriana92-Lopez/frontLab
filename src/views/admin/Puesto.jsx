...
import PuestoModal from "../Modals/admin/PuestoModal"
...
const Puesto = () => {
    ...
    return (
        <>
                    ...
                    <div className="col">
                        <Card className="shadow">
                            <CardHeader className="border-0">
                                <h3 className="mb-0">Administración de Puesto
            ...
            <PuestoModal modalOpen={modalOpen} nameController={nameController} ListPuesto={ListPuesto} toggleModal={toggleModal} opcion={opcion} information={contentInfor} setInformation={setContentInfor} />
        </>
    );
};
