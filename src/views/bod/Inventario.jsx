...
import InventarioModal from "../Modals/admin/InventarioModal"

const Inventario = () => {
    const nameController = "Inventario"
    ...
    const ListInventario = async () => {
        ...
        setListInventario((response.length) ? response : [])
    },
    ...
    const updateState = async (item) => {
        let messageToast = 'Inventario ' + (item.estado === 1 ? 'activado' : 'desactivado') + ' correctamente.';
    ...
    return (
        <>
                    ...
                    <div className="col">
                        <Card className="shadow">
                            <CardHeader className="border-0">
                                <h3 className="mb-0">Administración de Inventario
            ...
            <InventarioModal modalOpen={modalOpen} nameController={nameController} ListInventario={ListInventario} toggleModal={toggleModal} opcion={opcion} information={contentInfor} setInformation={setContentInfor} />
        </>
    );
};
