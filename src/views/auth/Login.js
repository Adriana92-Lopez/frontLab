            ...
            <Form onSubmit={handleSubmit(onSubmit)}>
              ...
              <FormGroup className="mb-3">
                ...
                <span className="text-danger text-small d-block mb-2">
                  {!!errors.usuario && <><i className="fas fa-exclamation-circle"></i> {errors.usuario.message}</>}
                </span>
              </FormGroup>
              <FormGroup>
                <InputGroup className="input-group-alternative">
                ...
                <span className="text-danger text-small d-block mb-2">
                  {!!errors.contrasena && <><i className="fas fa-exclamation-circle"></i> {errors.contrasena.message}</>}
                </span>
              </FormGroup>
