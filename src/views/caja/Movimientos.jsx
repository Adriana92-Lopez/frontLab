...
import MovimientosModal from "../Modals/admin/MovimientosModal"

const Movimientos = () => {
    const nameController = "Movimientos"
    ...
    const ListMovimientos = async () => {
        ...
        setListMovimientos((response.length) ? response : [])
    },
    ...
    return (
        <>
                    ...
                    <div className="col">
                        <Card className="shadow">
                            <CardHeader className="border-0">
                                <h3 className="mb-0">Administración de Movimientos de Caja
            ...
            <MovimientosModal modalOpen={modalOpen} nameController={nameController} ListMovimientos={ListMovimientos} toggleModal={toggleModal} opcion={opcion} information={contentInfor} setInformation={setContentInfor} />
        </>
    );
};
